...
const Profile = () => {
    ...
    const fetchUserProfile = async () => {
        ...
        try {
            ...
            setError(error.response?.data?.message || 'An error occured while fetching profile data')
        } finally {
            setLoading(false)
        }
    }
    ...
    const uploadProfilePictureFile = async(file) => {
        ...
        try {
            ...
            setError(error.response?.data?.message || 'An error occured while uploading profile picture')
        } finally {
            setLoading(false)
        }
    }
                ...
                <div className="profile-picture-section">
                    ...
                    <div className="profile-picture-upload">
                        ...
                        <div className="upload-controls">
                            ...
                            <button onClick={triggerFileInput} className="btn btn-primary" disabled={uploading} >
